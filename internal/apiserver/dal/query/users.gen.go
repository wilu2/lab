...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Channels = field.NewField(tableName, "channels")
	_user.Description = field.NewString(tableName, "description")
	_user.Abandoned = field.NewBool(tableName, "abandoned")
	_user.DelUniqueKey = field.NewInt32(tableName, "del_unique_key")
	_user.Ctime = field.NewTime(tableName, "ctime")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Channels = field.NewField(table, "channels")
	u.Description = field.NewString(table, "description")
	u.Abandoned = field.NewBool(table, "abandoned")
	u.DelUniqueKey = field.NewInt32(table, "del_unique_key")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["channels"] = u.Channels
	u.fieldMap["description"] = u.Description
	u.fieldMap["abandoned"] = u.Abandoned
	u.fieldMap["del_unique_key"] = u.DelUniqueKey
